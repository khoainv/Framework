...
using System.IO;
using SSD.Framework.BarcodeLib.Symbologies;
    ...
    public class Barcode: IDisposable
    {
                ...
                case TYPE.ITF14:
                    {
                        ...
                        int iquietzone = System.Convert.ToInt32(b.Width * 0.05);
                ...
                try
                {
                    using (BarcodeXML xml = new BarcodeXML())
                    {
                        ...
                        using (MemoryStream ms = new MemoryStream())
                        {
                            ...
                            row.Image = System.Convert.ToBase64String(ms.ToArray(), Base64FormattingOptions.None);
                        }//using
        ...
        public static Image GetImageFromXML(BarcodeXML internalXML)
        {
            try
            {
                ...
                using (MemoryStream ms = new MemoryStream(System.Convert.FromBase64String(internalXML.Barcode[0].Image)))
                {
