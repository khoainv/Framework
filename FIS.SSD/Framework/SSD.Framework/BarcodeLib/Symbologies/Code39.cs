namespace SSD.Framework.BarcodeLib.Symbologies
{
    ...
    class Code39 : BarcodeCommon, IBarcode
    {
        ...
        private void init_ExtendedCode39()
        {
            ...
            ExtC39_Translation.Add(System.Convert.ToChar(0).ToString(), "%U");
            ExtC39_Translation.Add(System.Convert.ToChar(1).ToString(), "$A");
            ExtC39_Translation.Add(System.Convert.ToChar(2).ToString(), "$B");
            ExtC39_Translation.Add(System.Convert.ToChar(3).ToString(), "$C");
            ExtC39_Translation.Add(System.Convert.ToChar(4).ToString(), "$D");
            ExtC39_Translation.Add(System.Convert.ToChar(5).ToString(), "$E");
            ExtC39_Translation.Add(System.Convert.ToChar(6).ToString(), "$F");
            ExtC39_Translation.Add(System.Convert.ToChar(7).ToString(), "$G");
            ExtC39_Translation.Add(System.Convert.ToChar(8).ToString(), "$H");
            ExtC39_Translation.Add(System.Convert.ToChar(9).ToString(), "$I");
            ExtC39_Translation.Add(System.Convert.ToChar(10).ToString(), "$J");
            ExtC39_Translation.Add(System.Convert.ToChar(11).ToString(), "$K");
            ExtC39_Translation.Add(System.Convert.ToChar(12).ToString(), "$L");
            ExtC39_Translation.Add(System.Convert.ToChar(13).ToString(), "$M");
            ExtC39_Translation.Add(System.Convert.ToChar(14).ToString(), "$N");
            ExtC39_Translation.Add(System.Convert.ToChar(15).ToString(), "$O");
            ExtC39_Translation.Add(System.Convert.ToChar(16).ToString(), "$P");
            ExtC39_Translation.Add(System.Convert.ToChar(17).ToString(), "$Q");
            ExtC39_Translation.Add(System.Convert.ToChar(18).ToString(), "$R");
            ExtC39_Translation.Add(System.Convert.ToChar(19).ToString(), "$S");
            ExtC39_Translation.Add(System.Convert.ToChar(20).ToString(), "$T");
            ExtC39_Translation.Add(System.Convert.ToChar(21).ToString(), "$U");
            ExtC39_Translation.Add(System.Convert.ToChar(22).ToString(), "$V");
            ExtC39_Translation.Add(System.Convert.ToChar(23).ToString(), "$W");
            ExtC39_Translation.Add(System.Convert.ToChar(24).ToString(), "$X");
            ExtC39_Translation.Add(System.Convert.ToChar(25).ToString(), "$Y");
            ExtC39_Translation.Add(System.Convert.ToChar(26).ToString(), "$Z");
            ExtC39_Translation.Add(System.Convert.ToChar(27).ToString(), "%A");
            ExtC39_Translation.Add(System.Convert.ToChar(28).ToString(), "%B");
            ExtC39_Translation.Add(System.Convert.ToChar(29).ToString(), "%C");
            ExtC39_Translation.Add(System.Convert.ToChar(30).ToString(), "%D");
            ExtC39_Translation.Add(System.Convert.ToChar(31).ToString(), "%E");
            ...
            ExtC39_Translation.Add(System.Convert.ToChar(127).ToString(), "%T"); //also %X, %Y, %Z 
        }
