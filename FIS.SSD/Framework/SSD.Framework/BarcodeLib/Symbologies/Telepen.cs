    ...
    class Telepen: BarcodeCommon, IBarcode
    {
        ...
        private void EncodeASCII(string input, ref string output)
        {
            try
            {
                foreach (char c in input)
                {
                    ...
                    iCheckSum += System.Convert.ToInt32(c);
                }//foreach
            }//try
            catch 
            {
        ...
        private void EncodeNumeric(string input, ref string output)
        {
            try
            {
                ...
                {
                    output += Telepen_Code[System.Convert.ToChar(Int32.Parse(input.Substring(i, 2)) + 27)];
        ...
        private void EncodeSwitchMode(ref string output)
        {
            ...
            iCheckSum += 16;
            output += Telepen_Code[System.Convert.ToChar(16)];
        }

        private char Calculate_Checksum(int iCheckSum)
        {
            return System.Convert.ToChar(127 - (iCheckSum % 127));
        ...
        {
            Telepen_Code.Add(System.Convert.ToChar(0), "1110111011101110");
            Telepen_Code.Add(System.Convert.ToChar(1), "1011101110111010");
            Telepen_Code.Add(System.Convert.ToChar(2), "1110001110111010");
            Telepen_Code.Add(System.Convert.ToChar(3), "1010111011101110");
            Telepen_Code.Add(System.Convert.ToChar(4), "1110101110111010");
            Telepen_Code.Add(System.Convert.ToChar(5), "1011100011101110");
            Telepen_Code.Add(System.Convert.ToChar(6), "1000100011101110");
            Telepen_Code.Add(System.Convert.ToChar(7), "1010101110111010");
            Telepen_Code.Add(System.Convert.ToChar(8), "1110111000111010");
            Telepen_Code.Add(System.Convert.ToChar(9), "1011101011101110");
            Telepen_Code.Add(System.Convert.ToChar(10), "1110001011101110");
            Telepen_Code.Add(System.Convert.ToChar(11), "1010111000111010");
            Telepen_Code.Add(System.Convert.ToChar(12), "1110101011101110");
            Telepen_Code.Add(System.Convert.ToChar(13), "1010001000111010");
            Telepen_Code.Add(System.Convert.ToChar(14), "1000101000111010");
            Telepen_Code.Add(System.Convert.ToChar(15), "1010101011101110");
            Telepen_Code.Add(System.Convert.ToChar(16), "1110111010111010");
            Telepen_Code.Add(System.Convert.ToChar(17), "1011101110001110");
            Telepen_Code.Add(System.Convert.ToChar(18), "1110001110001110");
            Telepen_Code.Add(System.Convert.ToChar(19), "1010111010111010");
            Telepen_Code.Add(System.Convert.ToChar(20), "1110101110001110");
            Telepen_Code.Add(System.Convert.ToChar(21), "1011100010111010");
            Telepen_Code.Add(System.Convert.ToChar(22), "1000100010111010");
            Telepen_Code.Add(System.Convert.ToChar(23), "1010101110001110");
            Telepen_Code.Add(System.Convert.ToChar(24), "1110100010001110");
            Telepen_Code.Add(System.Convert.ToChar(25), "1011101010111010");
            Telepen_Code.Add(System.Convert.ToChar(26), "1110001010111010");
            Telepen_Code.Add(System.Convert.ToChar(27), "1010100010001110");
            Telepen_Code.Add(System.Convert.ToChar(28), "1110101010111010");
            Telepen_Code.Add(System.Convert.ToChar(29), "1010001010001110");
            Telepen_Code.Add(System.Convert.ToChar(30), "1000101010001110");
            Telepen_Code.Add(System.Convert.ToChar(31), "1010101010111010");
            ...
            Telepen_Code.Add(System.Convert.ToChar(127), "1010101010101010");
