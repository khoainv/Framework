...
using SSD.Framework.Hashing.BCRYPT;
using SSD.Framework.Hashing.PBKDF2;
using SSD.Framework.Hashing.SCRYPT;

namespace  SSD.Framework.Hashing.Config
{
            ...
            try
            {
                ...
                switch (HashingAlgorithmType)
                {
                    ...
                    case HashingAlgorithmTypeEnum.SCRYPT:
                        return SCryptWapper.VerifyPassword(password, hash);
        ...
        public static string HashPassword(string password)
        {
            try
            {
                ...
                switch (HashingAlgorithmType)
                {
                    ...
                    case HashingAlgorithmTypeEnum.SCRYPT:
                        return SCryptWapper.HashPassword(password, SCryptRounds);
