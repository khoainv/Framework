...
namespace SSD.Framework.Network
{
	/// <summary>
	...
	public static class NetworkStatus
	{
        ...
        public static bool IsPingNetworkAvailable()
        {
            return IsPingNetworkAvailable("http://www.google.com");
        }
        public static bool IsPingNetworkAvailable(string host)
        {
            if (NetworkInterface.GetIsNetworkAvailable())
            {
                //Win 8
