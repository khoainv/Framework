...
namespace SSOWeb.Areas.Admin.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public async Task<ActionResult> Index(string sortOrder, int? page, string SearchString = "", bool isSystem = false)
        {
            ...
            Pager<ApplicationUser> pager = new Pager<ApplicationUser>(lst, pageno, pageSize, totalCount);
        ...
        // POST: /Users/Edit/5
        [HttpPost, ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,Address,City,Contry,IsSystemAccount")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
